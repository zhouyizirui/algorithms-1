...
function Event() {
    ...
    (function(o){
        ...
        o.subscribe = function(){
            handlers = handlers.concat(Array.prototype.slice.call(arguments).filter(function(v){
                return typeof v == "function";
            }));
        },
            o.unsubscribe = function(){
                handlers = Array.prototype.slice.call(arguments).reduce(function(p,v){
                    p.lastIndexOf(v) >= 0 && p.splice(p.lastIndexOf(v),1);
                    return p;
                },handlers);
            },
            o.emit = function(){
